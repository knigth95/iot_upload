...
import HistoryQuery from '@/pages/monitor/HistoryQuery/HistoryQuery'
...
import AIQAPage from '@/pages/cloud/AI/QA'
import AIAdvicePage from '@/pages/cloud/AI/Advice'
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/cloud/ai/advice',
        element: <AIAdvicePage />,
      },
      {
