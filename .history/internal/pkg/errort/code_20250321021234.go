...
const (
	...
	DefaultEmailRepeat          uint32 = 10017
	DefaultEmailFormatError     uint32 = 10018
	DefaultEmailNotVerified     uint32 = 10019
)
...
const (
	SystemErrorMsg        
	OpenApiErrorMsg = "system error,please contact the admin"
