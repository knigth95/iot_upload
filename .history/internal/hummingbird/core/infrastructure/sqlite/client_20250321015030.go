...
import (
	...
	clientSQLite "iot_pj/internal/tools/sqldb/sqlite"
)
...
func NewClient(config dtos.Configuration, lc logger.LoggingClient) (c *Client, errEdgeX error) {
	client, err := clientSQLite.NewGormClient(config, lc)
	if err != nil {
...
//func (c *Client) WithCache() error {
//    err := cache.NewCache()
//    if err != nil {
//        return err
//    }
//    c.cache = cache.GetCacheClient()
//    return nil
//}

// CloseSession closes the connections to Redis
func (c *Client) CloseSession() {
	//sqlite no need close?
}
