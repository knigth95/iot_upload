...
import (
	...
	"iot_upload/internal/pkg/di"
    "iot_upload/internal/pkg/logger"
    "iot_upload/internal/hummingbird/core/application/userapp"
)
...
func NewController(dic *di.Container) *controller {
    return &controller{
        dic:      dic,
