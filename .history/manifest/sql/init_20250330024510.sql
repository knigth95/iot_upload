...
--
-- Host: 127.0.0.1    Database: open-hummingbird
-- ------------------------------------------------------
...
CREATE TABLE `actions` (
  ...
  `code` varchar(255) DEFAULT NULL COMMENT '标识符',
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `description` text COMMENT '描述',
  `require` tinyint(1) DEFAULT NULL COMMENT '是否必须',
  `call_type` varchar(50) DEFAULT NULL COMMENT '调用方式',
  `input_params` text COMMENT '输入参数',
  `output_params` text COMMENT '输入参数',
  `tag` varchar(50) DEFAULT NULL COMMENT '标签',
  `system` tinyint(1) DEFAULT NULL COMMENT '系统内置',
  `created` bigint DEFAULT NULL COMMENT '创建时间',
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `fk_product_actions` (`product_id`),
  CONSTRAINT `fk_product_actions` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
--
-- Table structure for table `advance_config`
--
...
CREATE TABLE `advance_config` (
  `id` varchar(255) NOT NULL COMMENT '主键',
  `log_level` int DEFAULT '1' COMMENT '日志等级',
  `persist_storage` tinyint(1) DEFAULT '0' COMMENT '存储开关',
  `storage_hour` int DEFAULT '24' COMMENT '存储时长',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `advance_config`
--

LOCK TABLES `advance_config` WRITE;
/*!40000 ALTER TABLE `advance_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `advance_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `alert_list` (
  ...
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  `id` varchar(255) NOT NULL COMMENT '主键',
  `alert_rule_id` varchar(255) DEFAULT NULL COMMENT '告警记录ID',
  `trigger_time` bigint DEFAULT NULL COMMENT '触发时间',
  `alert_result` varchar(255) DEFAULT NULL COMMENT '告警内容',
  `status` varchar(50) DEFAULT NULL COMMENT '状态',
  `treated_time` bigint DEFAULT NULL COMMENT '处理时间',
  `message` text COMMENT '处理意见',
  `is_send` tinyint(1) DEFAULT NULL COMMENT '是否发送通知',
  PRIMARY KEY (`id`),
  KEY `fk_alert_list_alert_rule` (`alert_rule_id`),
  CONSTRAINT `fk_alert_list_alert_rule` FOREIGN KEY (`alert_rule_id`) REFERENCES `alert_rule` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `alert_list` WRITE;
/*!40000 ALTER TABLE `alert_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `alert_list` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `alert_rule` (
  ...
  `sub_rule` longtext,
  `notify` longtext,
  `silence_time` bigint DEFAULT NULL,
  `description` longtext,
  PRIMARY KEY (`id`),
  KEY `idx_alert_rule_device_id` (`device_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `category_template`
--
...
CREATE TABLE `category_template` (
  ...
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  `id` varchar(255) NOT NULL COMMENT '主键',
  `category_key` varchar(255) DEFAULT NULL COMMENT '品类标识',
  `category_name` varchar(255) DEFAULT NULL COMMENT '品类名字',
...
--
-- Dumping data for table `category_template`
--

LOCK TABLES `category_template` WRITE;
/*!40000 ALTER TABLE `category_template` DISABLE KEYS */;
INSERT INTO `category_template` VALUES (0,0,'1016943056','SensorSignalCollector','传感器信号采集器','公共场景'),
(0,0,'1083528962','EmergencyLight','应急照明灯','公共场景'),
(0,0,'1272495504','LightEnsor','光照传感器','公共场景'),
(0,0,'1353473731','Watch','手表','公共场景'),
(0,0,'1376371266','Siren','声光报警器','公共场景'),
(0,0,'1427185741','Lighting','路灯照明','公共场景'),
(0,0,'1709184249','Light','灯','公共场景'),
(0,0,'1935151447','Temperatureandhumiditysensor','室内温湿度监测设备','公共场景'),
(0,0,'1939472643','ConversionGateway','通用网关','公共场景'),
(0,0,'1954528545','Lamp','灯控开关','公共场景'),
(0,0,'226718712','TemperatureHumidityDetector','温湿度检测','公共场景'),
(0,0,'2486863848','CustomCategory','自定义品类','公共场景'),
(0,0,'2585140665','IlluminationSensor','光照度传感器','公共场景'),
(0,0,'2689841043','Airconditionerthermostat','空调温控器','公共场景'),
(0,0,'3863022173','CurrentTemperature','室内温度传感器','公共场景'),
(0,0,'656772030','ZigbeeTemplate','Zigbee功能模板','公共场景'),
(0,0,'754215611','TempHumiUnit','温湿度采集单元','公共场景');
/*!40000 ALTER TABLE `category_template` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `data_resource` (
  ...
  `health` tinyint(1) DEFAULT NULL COMMENT '验证',
  `option` text COMMENT '资源内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `device` (
  ...
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  `id` varchar(255) NOT NULL COMMENT '主键',
  `cloud_device_id` varchar(255) DEFAULT NULL COMMENT '云设备ID',
  `cloud_product_id` varchar(255) DEFAULT NULL COMMENT '云产品ID',
  `cloud_instance_id` varchar(255) DEFAULT NULL COMMENT '云实例ID',
  `drive_instance_id` varchar(255) DEFAULT NULL COMMENT '驱动实例ID',
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `device_sn` varchar(255) DEFAULT NULL COMMENT '设备唯一编码',
  ...
  `install_location` varchar(255) DEFAULT NULL COMMENT '安装地址',
  `last_sync_time` bigint DEFAULT NULL COMMENT '最后一次同步时间',
  `last_online_time` bigint DEFAULT NULL COMMENT '最后一次在线时间',
  PRIMARY KEY (`id`),
  KEY `idx_device_cloud_instance_id` (`cloud_instance_id`),
  KEY `idx_device_drive_instance_id` (`drive_instance_id`),
  KEY `fk_device_product` (`product_id`),
...
--
-- Table structure for table `device_library`
--
...
CREATE TABLE `device_library` (
  ...
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `description` text COMMENT '描述',
  `protocol` varchar(255) DEFAULT NULL COMMENT '驱动协议',
  `version` varchar(255) DEFAULT NULL COMMENT '当前安装版本',
  `container_name` varchar(255) DEFAULT NULL COMMENT '容器名字',
  `docker_config_id` varchar(255) DEFAULT NULL COMMENT '镜像仓库配置表id',
  `docker_repo_name` varchar(255) DEFAULT NULL COMMENT '镜像名称',
  `docker_image_id` varchar(255) DEFAULT NULL COMMENT '镜像ID',
...
CREATE TABLE `device_service` (
  ...
  `id` varchar(255) NOT NULL COMMENT '主键',
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `base_address` varchar(255) DEFAULT NULL COMMENT '地址',
  `device_library_id` varchar(255) DEFAULT NULL COMMENT '驱动ID',
  `config` varchar(255) DEFAULT NULL COMMENT '配置',
  `docker_container_id` varchar(255) DEFAULT NULL COMMENT 'docker容器ID',
  `expert_mode` tinyint(1) DEFAULT NULL COMMENT '扩展模式',
  `expert_mode_content` longtext COMMENT '扩展内容',
  `docker_params_switch` tinyint(1) DEFAULT NULL COMMENT 'docker启动参数开关',
  `docker_params` text COMMENT 'docker启动参数',
  `container_name` varchar(255) DEFAULT NULL COMMENT '容器名字',
  `log_level` int DEFAULT '1' COMMENT '日志等级',
  `driver_type` bigint NOT NULL DEFAULT '1' COMMENT '驱动类别，1：驱动，2：三方应用',
  `platform` longtext,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_device_service_device_library_id` (`device_library_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `doc` (
  ...
  `jump_link` varchar(255) DEFAULT NULL COMMENT '跳转地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `driver_classify`
--

LOCK TABLES `driver_classify` WRITE;
/*!40000 ALTER TABLE `driver_classify` DISABLE KEYS */;
INSERT INTO `driver_classify` VALUES (0,1705585912560,'9001','官方协议'),(0,1705585912566,'9002','网关'),(0,1705585912574,'9004','传感器'),(0,1705585912579,'9005','开关'),(0,1705585912601,'9999','其他');
/*!40000 ALTER TABLE `driver_classify` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `events` (
  ...
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `fk_product_events` (`product_id`),
  CONSTRAINT `fk_product_events` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `metrics` (
  ...
  `cpu_used_percent` double DEFAULT NULL,
...
CREATE TABLE `mqtt_auth` (
  ...
  `password` varchar(255) DEFAULT NULL COMMENT '密码',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_mqtt_auth_client_id` (`client_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mqtt_auth`
--

LOCK TABLES `mqtt_auth` WRITE;
/*!40000 ALTER TABLE `mqtt_auth` DISABLE KEYS */;
/*!40000 ALTER TABLE `mqtt_auth` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `msg_gather`
--
...
--
-- Dumping data for table `msg_gather`
--

LOCK TABLES `msg_gather` WRITE;
/*!40000 ALTER TABLE `msg_gather` DISABLE KEYS */;
/*!40000 ALTER TABLE `msg_gather` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `product` (
  ...
  `id` varchar(255) NOT NULL COMMENT '主键',
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `key` varchar(255) DEFAULT NULL COMMENT '产品标识',
  `cloud_product_id` varchar(255) DEFAULT NULL COMMENT '云产品ID',
  `cloud_instance_id` varchar(255) DEFAULT NULL COMMENT '云实例ID',
  ...
  `data_format` varchar(255) DEFAULT NULL COMMENT '数据类型',
  `last_sync_time` bigint DEFAULT NULL COMMENT '最后一次同步时间',
  `factory` varchar(255) DEFAULT NULL COMMENT '工厂名称',
  `description` text COMMENT '描述',
  `status` varchar(255) DEFAULT NULL COMMENT '产品状态',
  `extra` varchar(255) DEFAULT NULL COMMENT '扩展字段',
  PRIMARY KEY (`id`),
  KEY `idx_product_cloud_instance_id` (`cloud_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `properties` (
  ...
  `name` varchar(255) DEFAULT NULL COMMENT '名字',
  `code` varchar(255) DEFAULT NULL COMMENT '标识符',
  `access_mode` varchar(50) DEFAULT NULL COMMENT '读写模型',
  `require` tinyint(1) DEFAULT NULL COMMENT '是否必须',
  `type_spec` text COMMENT '属性物模型详情',
  `description` text COMMENT '描述',
  `tag` varchar(50) DEFAULT NULL COMMENT '标签',
  `system` tinyint(1) DEFAULT NULL COMMENT '系统内置',
  `created` bigint DEFAULT NULL COMMENT '创建时间',
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `fk_product_properties` (`product_id`),
  CONSTRAINT `fk_product_properties` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `quick_navigation`
--
...
CREATE TABLE `rule_engine` (
  ...
  `status` varchar(50) DEFAULT NULL COMMENT '状态',
  `filter` longtext,
  `data_resource_id` varchar(255) DEFAULT NULL COMMENT '资源ID',
  PRIMARY KEY (`id`),
  KEY `fk_rule_engine_data_resource` (`data_resource_id`),
  CONSTRAINT `fk_rule_engine_data_resource` FOREIGN KEY (`data_resource_id`) REFERENCES `data_resource` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rule_engine`
--

LOCK TABLES `rule_engine` WRITE;
/*!40000 ALTER TABLE `rule_engine` DISABLE KEYS */;
/*!40000 ALTER TABLE `rule_engine` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `scene_log`
--
...
CREATE TABLE `scene_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_scene_log_scene_id` (`scene_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `scene_log`
--

LOCK TABLES `scene_log` WRITE;
...
CREATE TABLE `thing_model_template` (
  ...
  `modified` bigint DEFAULT NULL COMMENT '更新时间',
  `id` varchar(255) NOT NULL COMMENT '主键',
  `category_key` varchar(255) DEFAULT NULL COMMENT '品类key',
  `category_name` varchar(255) DEFAULT NULL COMMENT '品类名字',
  `thing_model_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '物模型信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `thing_model_template`
--

LOCK TABLES `thing_model_template` WRITE;
/*!40000 ALTER TABLE `thing_model_template` DISABLE KEYS */;
INSERT INTO `thing_model_template` VALUES 
/*!40000 ALTER TABLE `thing_model_template` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `unit` (
  ...
  `unit_name` varchar(255) DEFAULT NULL COMMENT '单位名字',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `gateway_key` varchar(255) DEFAULT NULL COMMENT '密钥',
  `open_api_key` varchar(255) DEFAULT NULL COMMENT '密钥',
...
-- Dump completed on 2025-02-05 16:18:56
